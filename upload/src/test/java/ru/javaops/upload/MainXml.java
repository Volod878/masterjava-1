package ru.javaops.upload;

import com.google.common.base.Splitter;
import com.google.common.io.Resources;
import j2html.tags.ContainerTag;
import one.util.streamex.StreamEx;
import ru.javaops.upload.xml.schema.ObjectFactory;
import ru.javaops.upload.xml.schema.Payload;
import ru.javaops.upload.xml.schema.Project;
import ru.javaops.upload.xml.schema.User;
import ru.javaops.upload.xml.util.JaxbParser;
import ru.javaops.upload.xml.util.Schemas;
import ru.javaops.upload.xml.util.StaxStreamProcessor;
import ru.javaops.upload.xml.util.XsltProcessor;
...
public class MainXml {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try (Writer writer = Files.newBufferedWriter(Paths.get("upload/out/users.html"))) {
            writer.write(html);
        }
        ...
        try (Writer writer = Files.newBufferedWriter(Paths.get("upload/out/groups.html"))) {
            writer.write(html);
        }
    }
